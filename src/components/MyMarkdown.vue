<template>
    <div id="my-markdown" class="markdown-body">
        <VMdTextareaEditor :mode="`preview`" v-model="text"></VMdTextareaEditor>
    </div>
</template>
...
onMounted(() => {
    // md变量赋值
    text.value = `
<br>匡威体育用品（中国）有限公司（**“我们”**或**“匡威”**）非常注重保护用户（**“您”**）的个人信息及隐私，并希望通过《匡威隐私政策和Cookie政策概要》（**“本概要”**）向您简要介绍我们如何收集、使用和保护您的个人信息。本概要为《匡威隐私政策和Cookie政策》的介绍，如您希望了解我们详细的隐私政策及Cookie政策，请查阅本概要后的正文。
**一、我们如何收集和使用您的个人信息**
...
（2）发送电子邮件至我们的个人信息保护联络邮箱：123456789.com。`;
});
</script>
